...
import bigProject.counter.abstractClasses.View;
...
public class App_View extends View<App_Model> {
	...
	protected Scene create_GUI() {
       ...
       for (Locale locale : sl.getLocales()) {
       	...
       	menuOptionsConnection = new Menu(t.getString("program.menu.options.dialog"));
       	menuOptions.getItems().add(menuOptionsConnection);
	   ...
	   protected void updateTexts() {
           ...
           menuOptionsConnection.setText(t.getString("program.menu.options.dialog"));
	    }
}